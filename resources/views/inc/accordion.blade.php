<div class="container-fluid" id="999">
    ...
    <div class="row pt-5 pb-5">
        <div class="col-sm-4 mx-auto accordion-image" >
        </div>
            ...
            <div id="accordionExample" class="accordion shadow">
                ...
                <div class="card">
                    ...
                    <div id="collapseOne" aria-labelledby="headingOne" data-parent="#accordionExample" class="collapse show">
                        <div class="card-body p-5 text-center" >
                            <iframe src="https://www.google.com/maps/d/embed?mid=1N-02HuwFxEqa2F6pJqzaQmFlzHbKY2Of" width="700" height="380"></iframe>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div id="collapseTwo" aria-labelledby="headingTwo" data-parent="#accordionExample" class="collapse">
                        <div class="card-body p-5 text-center">
                            <iframe src="https://www.google.com/maps/d/embed?mid=1T5ZgP2Osz2Mso866BTOf3eYEi92mstrn" width="700" height="380"></iframe>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div id="collapseThree" aria-labelledby="headingThree" data-parent="#accordionExample" class="collapse">
                        <div class="card-body p-5 text-center">
                            <iframe src="https://www.google.com/maps/d/embed?mid=1x6mg2OxUEklR4jpVS_6gTLMt6XBXI6Hx" width="700" height="380"></iframe>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div id="collapseFour" aria-labelledby="headingFour" data-parent="#accordionExample" class="collapse">
                        <div class="card-body p-5 text-center">
                            <iframe src="https://www.google.com/maps/d/embed?mid=169_5EE8HwqtcYd7B4VhqLE0abjJdy3ny" width="700" height="380"></iframe>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div id="collapseFive" aria-labelledby="headingFive" data-parent="#accordionExample" class="collapse">
                        <div class="card-body p-5 text-center">
                            <iframe src="https://www.google.com/maps/d/embed?mid=1sZWqo7QcJLL_47p3bvAoI7zqLNYZN1VS" width="700" height="380"></iframe>
                        </div>
                    </div>
                </div>
