        ...
        <div class="hero-content-area d-flex justify-content-end">
            <div class="hero-text">
                ...
                @if(Session::get('role')=='admin' || Session::get('role')=='moderator')
                    <a href="/categories/createCategorie/{{$categorie_parent->Categorie_id}}" class="view-portfolio-btn" id="scrollDown">
            ...
            <div class="row">
                ...
                @if(Session::get('role')=='admin' || Session::get('role')=='moderator')
                    <div class="col-12 col-md-6 col-lg-4" style="padding-top: 4%;">
                        <ahref="/categories/createCategorie/{{$categorie_parent->Categorie_id}}">
